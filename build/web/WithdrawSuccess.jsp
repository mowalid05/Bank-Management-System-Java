...
<%
    ...
    boolean success = "Withdrawal successful".equalsIgnoreCase(message);
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="auth-container">
        <div class="card" style="max-width: 400px;">
            ...
            <p class="mb-4 text-center">
                <strong>Amount Withdrawn:</strong> <br> <%= String.format("%.2f", amount) %> EGP
            </p>
            <% } %>

            <a href="Withdraw.jsp" class="btn btn-outline-primary btn-block">
                <span class="icon-arrow-left"></span> Back to Withdraw
            </a>
        </div>
    </div>
</body>
