...
public class Manger extends Employee {
    ...
    public Manger(String firstName, String lastName, LocalDate bdate, Gender gender, int ssn, String email, String password, BigDecimal salary, String position, int branchId, Integer supervisorSsn) {
        super(firstName, lastName, bdate, gender, ssn, email, password, salary, position, branchId, supervisorSsn);
    }
    static public ArrayList<PendingApprovals> get_approval_requests(int managerSSN)
