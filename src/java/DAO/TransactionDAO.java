...
public class TransactionDAO {
    ...
    throw e;
        ...
        public static void validateSufficientFunds(Connection conn, int accountId, BigDecimal amount) 
    throws SQLException {
    
    String sql = "SELECT balance FROM Account WHERE account_id = ? FOR UPDATE";
    try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
        pstmt.setInt(1, accountId);
